...
export const MEETUPS: Meetup[] = [
  ...
  },
  {
     ...
     *
     * 톡방 공지로 announced 된 적이 **없다.** 한 분이 1인 한도인 4매를 잡아
     * 선착순으로 자리를 나눈 건이고, 뒤이어 신청한 분들은 자리를 못 잡았다
     * (원문 2026-08-26). 그러니 「우리 동호회가 간다」 는 뜻의 그냥 「확정」 은 아니다.
     *
     * 그렇다고 점선(`tent`)으로 두지도 않았다. 네 사람에게는 날짜·시각·좌석이
     * 이미 고정돼 있어 「아직 안 정해졌다」 도 사실이 아니기 때문이다.
     *
     * 갈림길은 **표 없는 회원이 현장에 가는 것**을 막는 것이다. 그래서 상태 글자와
     * 아래 note 가 「예매한 사람만」 이라고 분명히 말한다. 추가 참석은 각자
     * 예매해야 하고 마감이 10/1 이라 그 뒤에는 방법이 없다.
     */
    note: '예매하신 분들만 입장할 수 있습니다. 선착순으로 4석이 확보됐고 그 뒤 신청은 자리를 잡지 못했습니다. '
      + '함께 가시려면 10/1까지 각자 예매해 주세요 — 하반기 마지막 회차라 미루면 다음이 없습니다. '
