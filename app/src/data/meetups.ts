...
export const MEETUPS: Meetup[] = withDefaults([
  ...
  },
  {
     ...
     *
     * **집결을 16시로 당겼다 (2026-09-10 운영자 결정).** 투표 항목은 「17-18관람」 이었는데
     * 미술관이 회차 입장이라 **16시 회차를 예매한 회원**이 있었다(정리봇 9/1~9/7).
     * 17시 집결이면 그분들과 어긋나므로 16시에 모여 들어가고, 식사 시간(18시)은
     * 투표대로 둔다 — 관람이 두 시간이 되는 셈인데, 전시실이 넓어 60분은 빠듯했다.
     */
    time: '16:00 집결 · 16:00~18:00 관람 · 18:00~ 식사·티타임',
    /**
    ...
    description: '이주와 거주, 개인과 공동체, 공간과 기억을 탐구해 온 설치미술가 서도호의 '
      ...
      + '16시에 모여 관람하고, 18시부터 꽃누리들밥 경복궁점에서 저녁 식사와 티타임이 이어집니다.',
    /**
