...
export const MEETUPS: Meetup[] = withDefaults([
  ...
  },
  {
     ...
     *
     * 식사 장소는 「아직 안 정했습니다」 가 아니라 「재조정될 수 있습니다」 다 —
     * 톡방 2026-09-03 12:37 에 운영자 회의에서 다시 정할 수 있다고 밝혔다.
     * 정해진 적이 없는 것과, 정해도 바뀔 수 있는 것은 다르다.
     */
    note: '티켓은 각자 예매하셔야 합니다. 9월 7일(월) 오후 6시에 티켓이 열리고 '
      ...
      + '현재 신청 10명입니다. 관람 뒤 식사 장소는 운영자 회의에서 재조정될 수 있습니다.',
