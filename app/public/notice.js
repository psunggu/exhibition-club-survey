(function () {
  ...
  var FALLBACK_DIGEST = {
    ...
    "message_count": 119,
    "summary": "8월 16일 영화 정기관람을 마쳤고, 8월 22일 서울역사박물관 참여자 명단 확인과 덕수궁·정동길 수요조사 투표 종료, 가우디 서울전 집결 시간 조율이 이어지고 있습니다.",
    "highlights": [
      {
        "severity": "urgent",
        "label": "공식 정기관람",
      ...
      },
      {
        ...
        "text": "관람일은 8월 29일로 확정되어 있으며 집결 시간은 아직 정해지지 않았습니다. 얼리버드 기간 내 티켓 구매를 권장합니다."
      },
      {
        "severity": "check",
        "label": "투표 종료",
    ...
    "decisions": [
      "8월 16일 영화 《오디세이》 정기관람은 영등포 오후 5시 집결로 진행했습니다.",
