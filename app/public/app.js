...
const movieRankingUpdatedAt = "2026.08.24 03:12";
...
const boardUpdatedAt = "2026.09.05";
...
function renderMovieCard(movie) {
  const upcomingClass = movie.releaseStatus.includes("예정") ? " upcoming" : "";
  const releaseDateLabel = movie.releaseStatus.startsWith("재개봉") ? "재개봉일" : "개봉일";
  return `
    <article class="exhibition-card movie-card">
      ...
      <div class="exhibition-body">
        ...
        <dl class="exhibition-details">
          ${detailItem(releaseDateLabel, formatKoreanDate(movie.releaseDate))}
