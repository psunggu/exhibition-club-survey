...
const recommendedEvents = [
  ...
  },
  {
    ...
    region: "영등포/구로",
    type: "전시",
    title: "[2026 신진미술인 지원 프로그램] 최은빈 개인전 《Airborne》",
    genre: "설치, 사운드, 공간",
    startDate: "2026-07-27",
    endDate: "2026-08-09",
    visitDate: "2026-08-01",
    time: "11:00-20:00(개막일 15:00-20:00, 폐막일 10:00-17:00)",
    venue: "Hall 1",
    address: "서울 영등포구 양평로22마길 8",
    price: 0,
    priceType: "무료",
    discount: "무료 전시: 카드·통신사 할인 적용 대상 없음",
    parking: "확인 필요",
    parkingFee: "공식 상세에 전용 주차·요금 안내 없음. 차량 이용 전 전시장 문의, 인근 유료주차장 요금 별도 확인",
    docent: "도슨트 미운영",
    docentTime: "본 전시는 도슨트를 운영하지 않습니다.",
    difficulty: "가볍게",
    rating: "4",
    owner: "TOP 6",
    infoUrl: "https://sema.seoul.go.kr/kr/whatson/exhibition/detail?exNo=1563486",
    mapUrl: "https://map.kakao.com/?q=Hall%201%20%EC%84%9C%EC%9A%B8%20%EC%96%91%ED%8F%89%EB%A1%9C22%EB%A7%88%EA%B8%B8%208",
    summary: "공기를 언어와 기억을 매개하는 물질로 바라보고, 말소리·음악·노이즈와 빛·바람·안개를 공간 및 사운드 설치로 펼치는 개인전입니다.",
    recommendation: "오늘 개막한 짧은 전시로, 영등포권에서 동시대 설치·사운드 작업을 가볍게 관람하기 좋습니다.",
    notes: "8월 9일 종료. 공식 상세에 주차 정보가 없으므로 대중교통을 우선 권장합니다.",
    ratingReason: "신규 개막, 감각적인 공간 설치, 무료 관람이 강점.",
    sourceLabel: "SeMA 공식 전시 상세",
    verificationNote: "SeMA 공식 상세에서 전시명, 기간, 운영시간, 무료, 도슨트 미운영 확인; 주차 정보는 공식 미공지",
    updatedAt: "2026-07-27",
  },
  {
  ...
  },
  {
    ...
    discount: "카드·통신사 제휴 할인 공지 없음. 4인 25%, 3인 20%, 2인 15% 패키지, 학생 15%, 장애인·국가유공자 50%(조건·증빙 확인)",
    parking: "가능",
    ...
    notes: "5월 17일까지의 얼리버드 할인은 종료되었습니다. 롯데콘서트홀과 연동 판매되는 NOL 티켓 공연 전용 페이지에서 예매·잔여석을 확인하세요.",
  ...
  },
  {
    ...
    region: "인천",
    type: "공연",
    title: "인천시립합창단 제197회 정기연주회 《2026 뮤지컬 & 시네마 어드벤처》",
    genre: "합창, 뮤지컬, 영화음악",
    startDate: "2026-08-12",
    endDate: "2026-08-12",
    visitDate: "2026-08-12",
    time: "2026-08-12 19:30",
    venue: "인천문화예술회관 대공연장",
    address: "인천광역시 남동구 예술로 149",
    price: 0,
    priceType: "R석 30,000원, S석 20,000원",
    discount: "카드·통신사 제휴 할인 공지 없음. 컬쳐리더 유료회원·국가유공자·장애인·문화누리카드·경로·예술인패스·청소년·가족친화기업 직원·카카오톡플러스 친구·10인 이상 단체·다자녀 가정 50%(대상별 매수·증빙 조건 확인)",
    parking: "가능",
    ...
    rating: "4",
    owner: "인천 음악 2",
    infoUrl: "https://www.incheon.go.kr/art/ART010101/view?progrmSn=10864&resveGroupSn=5&resveProgrmSeCode=C",
    ...
    summary: "인천시립합창단이 뮤지컬과 영화음악 레퍼토리를 선보이는 제197회 정기연주회입니다.",
    recommendation: "뮤지컬·영화음악 중심이라 클래식 합창이 낯선 회원도 편하게 즐길 수 있고, 할인 대상이 폭넓습니다.",
    notes: "8세 이상 관람가. 7월 26일까지의 얼리버드 할인은 종료되었으며, 적용 가능한 할인은 증빙자료를 지참해야 합니다.",
    ratingReason: "친숙한 레퍼토리, 폭넓은 50% 할인, 평일 저녁 접근성이 강점.",
    sourceLabel: "인천문화예술회관 공식 공연 상세·주차 안내",
    verificationNote: "공식 상세에서 일시, 좌석별 관람료, 할인, 장소 확인; 공식 주차 안내에서 요금 확인",
    updatedAt: "2026-07-27",
  },
];
...
let activeArea = "서울";
const boardUpdatedAt = "2026.07.27 22:41";
const dataUpdatedAt = "2026-07-27";
...
function render() {
  ...
  elements.shareMeta.textContent = `2026.07.27 기준. ${activeArea} 추천 정보는 모임 전 공식 페이지에서 일정, 휴관일, 예매, 주차 정보를 다시 확인하세요.`;
