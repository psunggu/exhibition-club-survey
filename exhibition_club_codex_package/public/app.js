...
const recommendedEvents = [
  ...
  },
  {
    ...
    price: 0,
    priceType: "전석 무료",
    discount: "전석 무료: 카드·통신사 할인 적용 대상 없음. 공식 신청 허브에서 4th 18:00 회차 신청 마감 확인(2026-08-12 기준)",
    parking: "가능(세종로 공영주차장)",
    ...
    recommendation: "신규 신청은 마감됐습니다. 이미 신청해 관람 대상으로 선정된 회원이 당첨 안내와 티켓 수령 방법을 확인해 개별 관람하는 일정입니다.",
    notes: "7세 이상 관람 가능. 공식 신청 허브에 4th 18:00 회차가 ‘신청 마감’으로 표시됩니다. 선정 안내를 받은 경우에만 입장 절차를 확인하고, 주말 주차장 만차 가능성이 있어 대중교통을 권장합니다.",
    ratingReason: "무료 관람과 토요일 저녁 시간대, 세종체임버홀 접근성은 좋지만 신규 신청이 마감되어 현재 참여 가능성이 제한됨.",
    sourceLabel: "세종문화회관 공식 공연 상세·주차 안내",
    verificationNote: "공식 연속 공연 목록에서 4th의 정확한 상세 번호 37489와 일시·장소·러닝타임·관람연령·주차요금을 확인하고, 공식 신청 허브에서 4th 18:00 회차 마감을 재확인",
...
const boardUpdatedAt = "2026.08.12 23:44";
const dataUpdatedAt = "2026-08-12";
