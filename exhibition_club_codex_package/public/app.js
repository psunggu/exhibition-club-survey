...
const recommendedEvents = [
  ...
  },
  {
    ...
    docent: "공연 중 해설 진행",
    docentTime: "2026-09-10 11:00 공연 전체에 강석우 해설 포함(별도 도슨트 회차 없음)",
    difficulty: "사전예약",
    rating: "5",
    owner: "서울 음악 2",
    ...
    mainUrl: "https://www.sac.or.kr/",
    mapUrl: "https://map.kakao.com/?q=%EC%98%88%EC%88%A0%EC%9D%98%EC%A0%84%EB%8B%B9%20%EC%BD%98%EC%84%9C%ED%8A%B8%ED%99%80",
    summary: "강석우의 해설과 송안훈 지휘, 윤동환·차준호 협연, 프라임필하모닉오케스트라 연주로 슈트라우스 2세·생상스·베토벤·차이콥스키를 듣습니다.",
    recommendation: "평일 오전 모임에 맞고 가격 부담이 낮으며, 해설이 있어 클래식 입문자와 함께 관람하기 좋습니다.",
    notes: "초등학생 이상 관람가. 3층석은 복지 할인을 제외한 대부분 할인에서 제외되며, 할인 증빙을 현장에 지참해야 합니다.",
    ratingReason: "해설, 합리적인 가격, 폭넓은 프로그램과 9월 모임 일정 적합성이 강점.",
    sourceLabel: "예술의전당 공식 공연 상세·주차 안내",
    verificationNote: "공식 상세에서 일시, 러닝타임, 좌석별 관람료, 출연·프로그램과 할인 확인; 공식 주차 안내에서 요금 확인",
    updatedAt: "2026-07-31",
  },
  {
    ...
    time: "월·화·금 19:30, 수 14:00, 토·공휴일 14:00·18:00, 목·일 공연 없음. 8/4·11·25 도슨트 특별 회차는 15:00 공연",
    venue: "광야아트센터",
    ...
    docentTime: "2026-08-04·11·25 14:45 도슨트 시작, 15:00 공연 시작(8/18 제외)",
    difficulty: "사전예약",
    rating: "5",
    owner: "서울 음악 3",
    ...
    recommendation: "교회 모임의 성격과 잘 맞는 작품이며, 8월에는 공연 15분 전 해설이 붙는 특별 회차가 있어 작품의 역사적 배경을 이해하며 관람하기 좋습니다.",
    notes: "약 115분(인터미션 없음), 초등학생 이상 관람가. 공연장 직영 주차장이 없고 주변 교통이 혼잡해 대중교통 이용 권장.",
    ratingReason: "모임 주제 적합성, 창작진과 역사 소재, 8월 도슨트 특별 회차, 장기 공연 일정이 강점.",
    sourceLabel: "광야아트센터 공식 공연 상세·카카오 공식채널·공연장 FAQ",
    verificationNote: "공식 공연 상세에서 기간·시간·가격·관람등급 확인, 공식채널에서 8월 도슨트 회차와 홍보 패키지 할인 확인, 공연장 FAQ에서 주차요금 확인",
    updatedAt: "2026-07-31",
  },
  {
    id: "79c9f5b1-8684-4c2e-89be-a71bc5010208",
    recommendedRank: 14,
    verified: true,
    status: "공유완료",
    region: "종로/중구",
    type: "공연",
    title: "2026 제6회 《S Classic Week》 4th ‘사람의 조화’",
    genre: "클래식, 실내악, 음악축제",
    startDate: "2026-08-15",
    endDate: "2026-08-15",
    visitDate: "2026-08-15",
    time: "2026-08-15 18:00 (100분, 인터미션 15분 포함)",
    venue: "세종문화회관 세종체임버홀",
    address: "서울 종로구 세종대로 175",
    price: 0,
    priceType: "전석 무료",
    discount: "전석 무료: 카드·통신사 할인 적용 대상 없음. 공식 상세의 관람 신청 링크에서 사전 신청",
    parking: "가능(세종로 공영주차장)",
    parkingFee: "세종문화회관 자체 주차장 없음. 공연 티켓 제시 시 세종로 공영주차장 4시간 8,000원, 일반요금 5분당 430원",
    docent: "공연: 도슨트 적용 대상 아님",
    docentTime: "별도 공연 해설·도슨트 프로그램 공지 없음",
    difficulty: "사전신청",
    rating: "5",
    owner: "운영진 추천",
    infoUrl: "https://www.sejongpac.or.kr/portal/performance/performance/performTicket.do?performIdx=37489&menuNo=200320",
    ...
    summary: "S Classic Week의 네 번째 무대로, ‘사람의 조화’를 주제로 세종체임버홀에서 만나는 무료 클래식 공연입니다.",
    recommendation: "운영진 추천 · 공식 모임이 아닌 자유 관람입니다. 참가를 원하는 회원이 개별 신청해 선택적으로 관람하는 일정입니다.",
    notes: "7세 이상 관람 가능. 무료 사전 관람 신청 후 당첨 여부와 티켓 수령 방법을 공식 안내에서 확인하세요. 주말 주차장 만차 가능성이 있어 대중교통을 권장합니다.",
    ratingReason: "운영진 추천, 무료 관람, 토요일 저녁 시간대와 세종체임버홀 접근성을 높게 평가.",
    sourceLabel: "세종문화회관 공식 공연 상세·주차 안내",
    verificationNote: "사용자가 준 링크는 3rd(37488)였으나 공식 연속 공연 목록에서 4th의 정확한 상세 번호 37489를 확인하고, 일시·장소·러닝타임·관람연령·무료 신청·주차요금을 교차검증",
    linkLabel: "공식 공연·신청 안내",
  ...
  },
  {
    ...
    region: "고양/경기",
    type: "공연",
    title: "제184회 두레콘서트: 피아니스트 김설화 리사이틀 《설화의 여름》",
    genre: "클래식, 피아노 리사이틀",
    startDate: "2026-08-26",
    endDate: "2026-08-26",
    visitDate: "2026-08-26",
    time: "2026-08-26 19:30 (100분, 인터미션 15분 포함)",
    venue: "고양아람누리 새라새극장",
    address: "경기 고양시 일산동구 중앙로 1286",
    price: 0,
    priceType: "전석 33,000원",
    discount: "카드·통신사 제휴 할인 공지 없음. 고양문화재단 회원 10%(1인 4매), 국가유공자·장애인 본인 50%(중복할인 불가, 증빙 필수)",
    parking: "가능",
    parkingFee: "공연 티켓 제시 시 승용차 6시간 3,000원(대형 5,000원), 이후 5분당 190원. 일반 일일 최대 10,000원",
    docent: "공연: 도슨트 적용 대상 아님",
    docentTime: "별도 공연 해설·도슨트 프로그램 공지 없음",
    difficulty: "사전예약",
    rating: "5",
    owner: "운영진 추천",
    infoUrl: "https://www.artgy.or.kr/PF/PF0201V.aspx?showid=0000008380",
    mapUrl: "https://map.kakao.com/?q=%EA%B3%A0%EC%96%91%EC%95%84%EB%9E%8C%EB%88%84%EB%A6%AC%20%EC%83%88%EB%9D%BC%EC%83%88%EA%B7%B9%EC%9E%A5",
    summary: "제184회 두레콘서트로 마련된 피아니스트 김설화의 리사이틀이며, 고양아람누리 새라새극장에서 100분간 진행됩니다.",
    recommendation: "운영진 추천 · 공식 모임이 아닌 자유 관람입니다. 참가를 원하는 회원이 개별 예매해 선택적으로 관람하는 일정입니다.",
    notes: "초등학생 이상 관람 가능(미취학 아동 입장 불가). 할인 증빙 미지참 시 현장에서 정가 차액을 내야 합니다.",
    ratingReason: "운영진 추천, 피아노 독주 프로그램의 집중도, 평일 저녁 경기 북부 접근성과 공식 할인 정보의 명확성을 높게 평가.",
    sourceLabel: "고양문화재단 공식 공연 상세·주차 안내",
    verificationNote: "제공된 공식 포스터와 고양문화재단 상세에서 공연명·일시·장소·러닝타임·관람료를 대조하고, 공식 오시는 길에서 주차요금 확인",
    linkLabel: "고양문화재단 공식 공연·예매 안내",
    updatedAt: "2026-08-02",
  },
  {
