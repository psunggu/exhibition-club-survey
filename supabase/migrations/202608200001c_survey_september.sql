...
values (
  ...
  -- 8/21(금) 08시. 처음 받은 "8/22(금)" 은 요일이 어긋나 있었다 —
  -- 2026-08-22 는 토요일이고, 그날 15:00~17:30 에 서울역사박물관 정기관람이
  -- 잡혀 있어 마감이 관람 도중에 걸렸다. 8/21 은 금요일이고 겹치지 않는다.
  timestamptz '2026-08-21 08:00:00+09',
  '박지현',
