...
values (
  ...
  -- 8/22 17시로 연장했다 (2026-08-21 요청).
  --
  -- 주의: **2026-08-22 는 토요일이다.** 요청에는 "(금)" 이라 적혀 있었지만
  -- 금요일은 8/21 이다. 그리고 8/22 15:00~17:30 에 서울역사박물관 정기관람이
  -- 잡혀 있어 이 마감은 관람 도중에 걸린다. 날짜는 요청대로 두었다.
  timestamptz '2026-08-22 17:00:00+09',
  '박지현',
