...
- 2026-09-10 — 정합성 검토에서 관람 시각이 어긋나 있었다: 사이트는 「16:50 집결 · 17~18시 관람」(투표 항목 그대로), 정리봇은 「16시 회차 예매자가 있다」. 미술관이 회차 입장이라 둘이 양립하지 않는다. 운영자가 **16시 집결**로 정했다 — 관람 16~18시, 식사 18시는 투표대로. `meetups.ts` · `meetingBrief.ts` 의 시각을 함께 옮겼고, 지난 날짜(9/7 예매 오픈)를 미래형으로 말하던 달력 안내문도 현재형으로 고쳤다. 사이트에 남아 있던 식사 장소 설문(후보 셋에 정해진 식당이 없었다)은 운영자가 지운다.
